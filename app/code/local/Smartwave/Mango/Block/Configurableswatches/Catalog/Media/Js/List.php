<?php
class Smartwave_Mango_Block_Configurableswatches_Catalog_Media_Js_List extends Mage_ConfigurableSwatches_Block_Catalog_Media_Js_List {
    public function getProductImageFallbacks($keepFrame = null) {
		...
		$keepFrame = Mage::getStoreConfig("mango_settings/category/aspect_ratio",$code);
